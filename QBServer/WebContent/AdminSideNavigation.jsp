  ...
  <!-- Sidebar component with st-effect-1 (set on the toggle button within the navbar) -->
    ...
    margin-bottom: -15px;" alt="" src="AdminDashboardFiles/qbmslogo.jpg" ></a>          
      ...
      <ul class="sidebar-menu">
       ...
       <li class="active"> <a href="admindashboard.jsp"> <i class="fa fa-group"></i><span>Teacher Request</span></a></li>
       <li class="active"> <a href="admindashboard.jsp"> <i class="fa fa-user"></i><span>Teacher View</span></a></li>
       <li class="active"> <a href="admindashboard.jsp"> <i class="fa fa-pencil-square"></i><span>Create Course</span></a></li>
       <li class="active"> <a href="admindashboard.jsp"> <i class="fa fa-university"></i><span>Assign Teacher</span></a></li>
       <li class="active"> <a href="admindashboard.jsp"> <i class="fa fa-sign-out"></i><span>Logout</span></a></li>
      </div>
    </div>
